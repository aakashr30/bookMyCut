...
export default function BookNow() {
  ...
  // useEffect(()=>{
  //   const response = fetchViewSingleShopBarber(userToken, shopId);
  //   console.log(response, "barberresponsee");
  // },[userToken])
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        //   setServiceList(
        //     serviceResponse.data.map((s: any) => ({
        //       id: s._id,
        //       name: s.ServiceName,
